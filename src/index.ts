...
async function tester() {
    ...
    let server = await mcss.getServerStats('a06c56c4-6eeb-406c-8038-0bd913f03723')
    let details = await mcss.getServerDetails('a06c56c4-6eeb-406c-8038-0bd913f03723')
    console.log( `Server count: `, count.data.count )
    console.log( `Servers: `, servers.data )
    console.log( `Server: `, server.data )
    console.log( `Server details: `, details.data )
}
